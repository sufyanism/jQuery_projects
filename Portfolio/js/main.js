...
$(".site-name").mouseover(function(){
  $(".site-name").css("font-size", "32px");
});

$(".site-name").mouseout(function(){
  $(".site-name").css("font-size", "28px");
});

$(".about-pic").hover(function(){
  $(this).css("box-shadow", " 0px 0px 2px 4px #000000");
  }, function(){
